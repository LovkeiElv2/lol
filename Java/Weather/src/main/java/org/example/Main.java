...
public class Main {
    public static void main(String[] args) {
        ...
        // Количество дней в каждом месяце (индексы 0-11 для январь-декабрь)
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    int userMonth = scanner.nextInt() - 1; // Преобразуем к индексу (0-11)
                    if (userMonth < 0 || userMonth > 11) {
                        System.out.println("Неверный номер месяца.");
                        break;
                    }
                    System.out.print("Введите номер дня (1-" + daysInMonth[userMonth] + "): ");
                    int userDay = scanner.nextInt() - 1; // Преобразуем к индексу (0-30/29/28)
                ...
                default:
                    System.out.println("Неверный выбор. Пожалуйста, выберите вариант от 1 до 4.");
                    break;
            }
        }
    }
